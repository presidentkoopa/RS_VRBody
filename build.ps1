...
foreach ($m in @('models/vrtorso.mdl','models/legholster.mdl','models/hand.mdl','models/openhand.mdl','models/boot/Boot.md3','models/boot/Boot.png','sprites/TRSOA0.png','zscript/body_rig.zs','models/vest_green.kvx','models/vest_blue.kvx','models/vest_pal.png','models/vest_pal_red.png') + $handFrames) {
